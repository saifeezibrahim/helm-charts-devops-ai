...
| backend.asgi.autoscaling.REDACTED | int | `80` | Target Memory utilization percentage |
...
| backend.celery.autoscaling.REDACTED | int | `80` | Target Memory utilization percentage |
...
| backend.config.REDACTED | string | `""` | When sharing views publicly a websocket connection is opened to provide realtime updates to viewers of the public link. To disable this set any non empty value. When disabled publicly shared links will need to be refreshed to see any updates to the view. |
...
| backend.config.REDACTED | string | `""` | Items from the trash will be permanently deleted after this number of hours. |
...
| backend.wsgi.autoscaling.REDACTED | int | `80` | Target Memory utilization percentage |
...
| frontend.autoscaling.REDACTED | int | `80` | Target Memory utilization percentage |
