...
| auth.password | string | `"$2a$08$REDACTED.WtBshWdl2"` | Password for basic authentication. Should be a salted bcrypt hash of the password. Can be generated e.g. using https://timetagger.app/cred. |
| auth.username | string | `"test"` | Username for basic authentication |
| autoscaling.enabled | bool | `false` | Enable Horizontal POD autoscaling |
| autoscaling.maxReplicas | int | `100` | Maximum number of replicas |
| autoscaling.minReplicas | int | `1` | Minimum number of replicas |
| autoscaling.targetCPUUtilizationPercentage | int | `80` | Target CPU utilization percentage |
| autoscaling.REDACTED | int | `80` | Target Memory utilization percentage |
