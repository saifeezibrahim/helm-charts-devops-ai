...
<!-- ALL--BADGE:START - Do not remove or modify this section -->
[![All ](https://img.shields.io/badge/all_-11-orange.svg?style=flat-square)](#-)
<!-- ALL--BADGE:END -->
<!-- prettier-ignore-end -->
...
s.org/docs/en/emoji-key)):

<!-- ALL--LIST:START - Do not remove or modify this section -->
<!-- prettier-ignore-start -->
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td align="center" valign="top" width="14.28%"><a href="http://REDACTED.blogspot.fr/"><img src="https://avatars.githubusercontent.com/u/277760?v=4?s=100" width="100px;" alt="Yannig"/><br /><sub><b>Yannig</b></sub></a><br /><a href="https://github.com/pascaliske/helm-charts/commits?author=Yannig" title="Code">💻</a></td>
...
This project follows the [all-](https://github.com/all-/all-) specification. Contributions of any kind welcome!
